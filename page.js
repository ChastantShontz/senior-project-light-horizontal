...
function resizeHeader() {
  var element = document.getElementsByClassName("modal")[0].id;
  if ((document.getElementById(element).getBoundingClientRect().top < document.getElementsByTagName("header")[0].getBoundingClientRect().bottom) || (document.getElementById(element).getBoundingClientRect().top > document.getElementsByTagName("header")[0].getBoundingClientRect().bottom)) {
    ...
    document.getElementsByTagName("header")[0].style.height = heightValue + "px";
    document.getElementsByTagName("header")[0].style.transition = "height 0s ease 0s";
    document.getElementById("navHeadshot").style.height = (heightValue - 10) + "px";
    document.getElementById("navHeadshot").style.width = (heightValue - 10) + "px";
    document.getElementById("navHeadshot").style.transition = "all 0s ease 0s";
  }
}

function showSidebar() {
  document.getElementById("navMenuEnter").style.visibility = "hidden";
  document.getElementById("navMenuEnter").style.opacity = "0";
  document.getElementById("navMenuEnter").style.transition = "all .1s ease 0s";
  document.getElementById("sidebar").style.right = "0";
  document.getElementById("sidebar").style.transition = "right .5s ease 0s";
  document.getElementById("navMenuExit").style.visibility = "visible";
  document.getElementById("navMenuExit").style.opacity = "1";
  document.getElementById("navMenuExit").style.transition = "all 0s ease 0s";
}

function hideSidebar(event) {
  if (((event.type == "resize") && ((window.innerWidth >= 768) && (document.getElementById("sidebar").style.right == "0px"))) || (event.type == "click")) {
    document.getElementById("navMenuExit").style.visibility = "hidden";
    document.getElementById("navMenuExit").style.opacity = "0";
    document.getElementById("navMenuExit").style.transition = "all .1s ease 0s";
    document.getElementById("sidebar").style.right = "-10em";
    document.getElementById("sidebar").style.transition = "right .5s ease 0s";
    document.getElementById("navMenuEnter").style.visibility = "visible";
    document.getElementById("navMenuEnter").style.opacity = "1";
    document.getElementById("navMenuEnter").style.transition = "all 0s ease 0s";
  }
}
